...
//Reset Controll -------------------------------------------
reg [31:0] time_counter = 0;//every 100s, perform a reset.
...
reg [127:0] read_buf_s0=0;//2 stages buffer for higher Fmax
reg [127:0] read_buf_s1=0;

reg [127:0] read_data[7:0];
reg [2:0] read_data_pos=0;
